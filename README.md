...
To explore or reproduce this project locally: 
Clone the repository: 
bash git clone https://github.com/rithishvellingiri/ibm-hr-analytics 
Install the dependancies such  pandas numpy matplotlib seaborn scikit-learn joblib  streamlit
